package com.example.custom.annotation.custom.annotation;
...
public class AuthorizeUserAspect {
    ...
    @After("@annotation(AuthorizeUser)")
    public void beforeAuthorize(JoinPoint jp) throws Throwable {
        System.out.println("After the controller inside aspect");
    }
}
